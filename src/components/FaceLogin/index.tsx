...
// import { FACE_DETECTION_URL } from '../../global/index'
...
// //   // New states for progress circle
...
// //     if (!referenceBase64 || images.length === 0) {
// //       setError(constant.imageIssue);
// //       resetCapture();
// //       return;
// //     }
// //     setLoading(true);
...
// //         "http://localhost:8000/api/verifyface",
// //         {
// //           reference_image_base64: referenceBase64,
// //           live_image_base64_list: images,
// //         },
// //         {
// //           headers: {
...
// //       if (res.data.error) {
// //         if (res.data.error == "Unexpected error: name 'paylo' is not defined") {
// //           setResult({ error: "Server Busy, please try again" });
// //         }
// //         else {
// //           setResult({ error: "Face not detected, please ensure your face is clearly visible." });
// //         }
// //       } else {
// //         setResult(res.data);
// //       }
...
// //           const isClose = faceRatio > 0.25;
// //           setFaceOk(isClose);

// //           if (isCapturing && !isClose) {
// //             resetCapture();
// //           }
// //         } else {
// //           setFaceOk(false);
// //           // capturing process is on and face not visible
// //           if (isCapturing) {
// //             resetCapture();
// //           }
// //         }
...
// //         {!faceOk && !isCapturing && (
// //           <h3 style={styles.heading}>Come closer and fit your face in frame</h3>
// //         )}
// //         {loading && (
// //           <p style={{ marginBottom: "1rem", fontWeight: "500", color: "#0077cc" }}>
// //             Processing...
// //           </p>
// //         )}
...
// //                   style={{
// //                     position: "relative",
// //                     border: `4px solid ${faceOk ? "green" : "red"}`,
// //                     borderRadius: "50%",
// //                     width: "210px",
// //                     height: "300px",
// //                     overflow: "hidden",
...
// //                       objectFit: "cover",
// //                     }}
// //                     onUserMediaError={() => setError(constant.webcamIssue)}
// //                     videoConstraints={{
// //                       width: { ideal: 640 },
// //                       height: { ideal: 480 },
// //                       facingMode: "user",
...
// //                 <div>
// //                   <strong>Liveness:</strong> {result.liveness.label} ({result.liveness.confidence * 100}%)
// //                 </div>
// //                 <div>
// //                   <strong>Matched:</strong> {result.face_match.matched}
// //                 </div>
// //                 <div>
// //                   <strong>Similarity:</strong> {result.face_match.similarity}%
// //                 </div>
// //               </div>
// //             )}
// //           </div>
...
// //         <button onClick={onClose} style={{ ...styles.button, marginTop: "1rem" }}>
// //           Close
// //         </button>
// //       </div>
// //     </div >,
...
// // const FaceVerifyWithBaseImage: React.FC = () => {
// //   const [referenceBase64, setReferenceBase64] = useState<string | null>(null);
// //   const [preview, setPreview] = useState<string | null>(null);

// //   const navigate = useNavigate();

// //   const openModal = (initialError: string | null = null) => {
// //     const container = document.createElement("div");
// //     const mytoken = localStorage.getItem("apiKey");
...
// //       openModal();
// //     } catch {
// //       openModal(constant.webcamIssue);
// //     }
// //   };
...
// //           <button style={styles.navButton} onClick={() => navigate("/FaceVerifyWithBaseImage")}>
...
//         {
//           reference_image_base64: 'data:image/jpeg;base64,' + loimage,
//           live_image_base64_list: images,
//         },
//         {
...
//       // }
//       // }
//       // console.log("FACE LOGIN RESPONSE",res?.data);

//       if (res?.data?.error) {
//         setResult({ error: res.data.error });
//       } else {

//         // function to login for LO here ** and generate 
...
//           setResult({ error: "User Unauthenticate ! Please Connect With Admin or Retry" });
//         }
//       }
//     } catch (err) {
//       console.error(err);
...
//           // alert(faceRatio)
//           const isClose = faceRatio > 0.20;
//           setFaceOk(isClose);

//           if (isCapturing && !isClose) resetCapture();
//         } else {
//           setFaceOk(false);
//           if (isCapturing) resetCapture();
//         }
//       }
//     }, 2000);
...
//                     >
//                       <circle cx="105" cy="150" r="100" stroke="rgba(0,255,0,0.3)" strokeWidth="8" fill="none" />
//                       <circle
//                         cx="105"
//                         cy="150"
//                         r="100"
...
//                 </div>
//                 <div>
//                   <strong>Matched:</strong> {result.face_match.matched.toString()}
//                 </div>
//                 <div>
//                   <strong>Similarity:</strong> {result.face_match.similarity}%
//                 </div> */}
...
//     } catch {
//       setModalError(constant.webcamIssue);
//       setShowModal(true); // open modal with error
//     }
//   };
...
//             // onClick={() => navigate("/FaceVerifyWithBaseImage")}
//             onClick={handleClick}
...
//         {/* Modal rendered inside the component */}
//         {showModal && (
//           <FaceVerifyModal
//             referenceBase64={referenceBase64}
